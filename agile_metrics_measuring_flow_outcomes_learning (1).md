...
They help teams learn and continuously improve.
...
> If you only track one category of metrics, track **flow metrics**.
...
- Planned work vs completed work over time (trend‑based)
...
#### Rework Rate
- Work repeated due to defects or misunderstandings
...
OKRs and Agile metrics serve **different but complementary purposes**.
...
**Objectives** describe desired outcomes.  
**Key Results** define measurable success.  
